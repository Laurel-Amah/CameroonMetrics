  ...
  return (
    <div className="mx-auto max-w-6xl px-4 pb-24 pt-11 sm:px-6 sm:pb-28 sm:pt-14 lg:px-8 lg:pb-32 lg:pt-16">
      <header className="relative mb-12 max-w-3xl sm:mb-14 lg:mb-16">
        <div className="relative rounded-2xl border border-line bg-surface-card py-8 pl-6 pr-6 shadow-card ring-1 ring-line/80 sm:py-10 sm:pl-8 sm:pr-10">
          <div
            className="pointer-events-none absolute left-0 top-6 h-[calc(100%-3rem)] w-[3px] rounded-full bg-brand/70 sm:top-8 sm:h-[calc(100%-4rem)]"
            aria-hidden
          />
      ...
      <section
        className="rounded-2xl border border-line bg-surface px-4 py-10 shadow-card ring-1 ring-line/70 sm:rounded-[1.35rem] sm:px-9 sm:py-12 lg:px-11 lg:py-14"
        aria-labelledby="feed-heading"
      >
        <div className="relative mb-11 border-b border-line pb-11 sm:mb-12 sm:pb-12">
          <div className="absolute inset-x-0 -top-px h-px bg-brand/20" />
          <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between sm:gap-6">
            <div className="space-y-3">
              ...
              <div className="flex flex-wrap items-baseline gap-x-3 gap-y-1">
                ...
                <span className="hidden h-1 w-1 rounded-full bg-accent shadow-sm sm:inline-block" />
                <span className="text-sm font-semibold tabular-nums text-ink-muted">
                  {articles.length} stories
                </span>
              </div>
              <div className="flex items-center gap-3">
                <div className="h-0.5 flex-1 max-w-[9rem] rounded-full bg-brand/25 sm:max-w-[11rem]" />
                <div className="h-1 w-1 shrink-0 rounded-full bg-brand/40 ring-1 ring-brand/15" />
              </div>
            </div>
